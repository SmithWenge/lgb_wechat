...
public class LoginController {
    ...
    public ModelAndView login(AdminUser adminUser, HttpSession session,@RequestParam("authCode") String authCode) {
    ...
    public ModelAndView resetPass(AdminUser adminUser,HttpSession session,@RequestParam("authCode") String authCode) {
        Object sessionCode = session.getAttribute(Constants.KAPTCHA_SESSION_KEY);
        if (sessionCode == null ) {
            return new ModelAndView("redirect:/admin/routeLogin.action");
        }
